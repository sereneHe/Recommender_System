...
```text
S0  实验搜索空间与可运行锚点  [注册✓ · 证据missing · -]  runs u1364/v874 · pairs 0  (代码)
...
├─ A1  A1 优化器与约束求解后端  [注册✓ · 证据missing · -]  runs u1364/v874 · pairs 0  (代码)
...
├─ A2  A2 约束嵌入与组合方式  [注册✓ · 证据missing · -]  runs u1364/v874 · pairs 0  (代码)
...
├─ A3  A3 条件独立统计量与不确定性  [注册✓ · 证据missing · -]  runs u1364/v874 · pairs 0  (代码)
...
├─ A4  A4 图估计与因果先验  [注册✓ · 证据missing · -]  runs u1364/v874 · pairs 0  (代码)
...
├─ A5  A5 模型容量与训练预算  [注册✓ · 证据missing · -]  runs u1364/v874 · pairs 0  (代码)
...
├─ A6  A6 数据表示、时间结构与鲁棒损失  [注册✓ · 证据missing · -]  runs u1364/v874 · pairs 0  (代码)
│  ├─ A6.standardization  A6.1 数据尺度：raw / 标准化 / Gaussianization  [实现✓ · 证据missing · - ×crossed]  runs u609/v363 · pairs 0  (代码)
│  ├─ A6.lag  A6.2 预测变量滞后  [实现✓ · 证据complete · contradicted(FRED) ×crossed]  runs u66/v66 · pairs 48  (代码)
...
│        ◇ cohort: nan=invalid_pairing
├─ G0  G0 公平比较与可追溯性合同  [注册✓ · 证据missing · -]  runs u1364/v874 · pairs 0  (代码)
│  ├─ G0.1_metric_schema_valid  G0.1 指标表结构有效  [实现✓ · 证据missing · checker_implemented]  runs u874/v874 · pairs 0  (代码)
│  ├─ G0.2_complete_artifact  G0.2 运行产物完整  [实现✓ · 证据missing · checker_implemented]  runs u758/v758 · pairs 0  (代码)
...
|---|---|---|---|---|---|---|---|---:|---:|---:|
| S0 | S0 | 代码 | False | 注册✓ | missing | - | 1364 | 874 | 0 |
...
| A1 | A1 | 代码 | False | 注册✓ | missing | - | 1364 | 874 | 0 |
...
| A2 | A2 | 代码 | False | 注册✓ | missing | - | 1364 | 874 | 0 |
...
| A3 | A3 | 代码 | False | 注册✓ | missing | - | 1364 | 874 | 0 |
...
| A4 | A4 | 代码 | False | 注册✓ | missing | - | 1364 | 874 | 0 |
...
| A5 | A5 | 代码 | False | 注册✓ | missing | - | 1364 | 874 | 0 |
...
| A6 | A6 | 代码 | False | 注册✓ | missing | - | 1364 | 874 | 0 |
| A6.standardization | A6 | 代码 | True | 实现✓ | missing | - | 609 | 363 | 0 |
| A6.lag | A6 | 代码 | True | 实现✓ | complete | contradicted(FRED) | 66 | 66 | 48 |
...
| G0 | G0 | 代码 | False | 注册✓ | missing | - | 1364 | 874 | 0 |
| G0.1_metric_schema_valid | G0 | 代码 | False | 实现✓ | missing | checker_implemented | 874 | 874 | 0 |
| G0.2_complete_artifact | G0 | 代码 | False | 实现✓ | missing | checker_implemented | 758 | 758 | 0 |
